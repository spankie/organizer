...
// Id doesn't exist
func GetOrganizationById(id int64) (v *Organization, err error) {
	o := orm.NewOrm()
	v = &Organization{Id: id}
	if err = o.QueryTable(new(Organization)).Filter("Id", id).RelatedSel().One(v); err == nil {
		return v, nil
	}
	return nil, err
}
...
func DeleteOrganization(id int64) (err error) {
	o := orm.NewOrm()
	v := Organization{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
